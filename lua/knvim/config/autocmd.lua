...
vim.api.nvim_create_autocmd({ "VimEnter" }, {
  callback = function()
    vim.cmd.colorscheme(Knvim and Knvim.colorscheme or "habamax")
  end,
})

vim.api.nvim_create_autocmd({ "UIEnter", "BufReadPost", "BufNewFile" }, {
  group = vim.api.nvim_create_augroup("KnvFilePost", { clear = true }),
  callback = function(args)
    ...
    if file ~= "" and buftype ~= "nofile" and vim.g.ui_entered then
      ...
      vim.api.nvim_del_augroup_by_name "KnvFilePost"
